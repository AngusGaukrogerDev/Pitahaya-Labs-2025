    ...
    <footer className="bg-beige">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h4 className="text-lg font-medium text-black">Quick Links</h4>
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#contact" className="text-black hover:text-yellow transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-black">contact@pitahayalabs.com</li>
              <li className="text-black">+1 (555) 123-4567</li>
              <li className="text-black">123 Tech Street, San Francisco, CA 94105</li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-black hover:text-yellow transition-colors">
